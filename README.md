...
# --- IMPLEMENTAÇÃO DA OPÇÃO 2: DETALHES DA OS COM ENDEREÇO DO CLIENTE ---
def relatorio_detalhado_pedido():
    ...
    # SELECT atualizado para trazer 'c.endereco' da tabela clientes
    cursor.execute("""
    ...
    print(f"Endereço do Serviço: {endereco_exibicao} 📍") # Novo campo visual exibido aqui!
